...
describe('Router', () => {
  ...
  const pair_weth_0 = new Pair(
    new TokenAmount(WRAPPED_NATIVE[ChainId.MAINNET], '1000'),
  ...
  describe('#swapCallParameters', () => {
    describe('exact in', () => {
      it('ether to token1', () => {
        const result = Router.swapCallParameters(
          Trade.exactIn(new Route([pair_weth_0, pair_0_1], NATIVE, token1), CurrencyAmount.native(JSBI.BigInt(100))),
    ...
    describe('exact out', () => {
      ...
      it('token1 to ether', () => {
        const result = Router.swapCallParameters(
          Trade.exactOut(new Route([pair_0_1, pair_weth_0], token1, NATIVE), CurrencyAmount.native(JSBI.BigInt(100))),
          { ttl: 50, recipient: '0x0000000000000000000000000000000000000004', allowedSlippage: new Percent('1', '100') }
        )
        ...
        it('token1 to ether', () => {
          expect(() =>
            Router.swapCallParameters(
              Trade.exactOut(
                new Route([pair_0_1, pair_weth_0], token1, NATIVE),
                CurrencyAmount.native(JSBI.BigInt(100))
              ),
              {
                ttl: 50,
                recipient: '0x0000000000000000000000000000000000000004',
